...
def _parallel_build_trees(tree, forest, X, y, sample_weight, tree_idx, n_trees,
    ...
    # Adding Baysesian Bootstrap Method
    elif forest.bayesian_bootstrap:
        n_samples = X.shape[0]
        if sample_weight is None:
            curr_sample_weight = np.ones((n_samples,), dtype=np.float64)
        else:
        ...
        sample_counts = np.random.exponential(scale=1, size=n_samples)
        #print("Utilisation de la méthode Bayesienne") # Debugging tool
        curr_sample_weight *= sample_counts
...
class BaseForest(BaseEnsemble, MultiOutputMixin, metaclass=ABCMeta):
    ...
    def __init__(self,
                 ...
                 bootstrap=False,
                 bayesian_bootstrap=False, # Add Bayesian Bootstrap option
                 oob_score=False,
                 n_jobs=None,
                 random_state=None,
                 verbose=0,
